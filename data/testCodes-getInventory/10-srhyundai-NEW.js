fetch("https://www.srhyundai.com/api/widget/ws-inv-data/getInventory", {
    "headers": {
        "accept": "*/*",
    ...
    "body": JSON.stringify({
        ...
        "preferences": {
            ...
            "inTransitStatuses": "",
            "customInTransitLogoUrl": "/static/sites/wise/oem/hyundai/in-transit-badge/images/hyundai_intransit_icon.svg",
            "carfaxLogoBlackWhite": "false",
            "hideCertifiedDefaultLogo": "false",
            "sorts": "year,internetPrice,paymentLoan,paymentLease",
            "sortsTitles": "YEAR,PRICE,LOAN,LEASE",
