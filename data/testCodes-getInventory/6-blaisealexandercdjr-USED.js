fetch("https://www.blaisealexandercdjr.com/api/widget/ws-inv-data/getInventory", {
    "headers": {
        "accept": "*/*",
    ...
    "body": JSON.stringify({
        ...
        "inventoryParameters": {
            "accountId": "blaisealexanderchryslerdodgejecllc"
        },
        "preferences": {
            ...
            "showFranchiseVehiclesOnly": "false",
