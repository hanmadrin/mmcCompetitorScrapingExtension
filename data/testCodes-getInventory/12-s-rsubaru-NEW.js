fetch("https://www.s-rsubaru.com/api/widget/ws-inv-data/getInventory", {
    "headers": {
        "accept": "*/*",
    ...
    "body": JSON.stringify({
        ...
        "preferences": {
            ...
            "displayerInstanceId": "INVENTORY_LISTING_DEFAULT_AUTO_NEW:inventory-listing1_1344631274",
            ...
            "facetInstanceId": "INVENTORY_LISTING_DEFAULT_AUTO_NEW:inventory-listing1",
            ...
            "sorts": "year,exteriorColor,internetPrice",
            "sortsTitles": "YEAR,COLOR,PRICE",
            "inventoryDateFormat": "E_MMM_DD_YYYY_FORMAT",
            "offsiteInventoryMarkup": "0",
            "showEffectiveStartDate": "true",
            "showIncentiveTitleSubText": "true",
            "showIncentiveAmountAndLabel": "false",
